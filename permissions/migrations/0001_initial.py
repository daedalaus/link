    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=200, verbose_name='描述')),
                ('is_active', models.BooleanField(default=False, verbose_name='是否启用')),
                ('permissions', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='permissions.Permission', verbose_name='拥有权限')),
            ],
            options={
                'db_table': 'roles',
            },
        ...
        migrations.AddField(
            model_name='user',
            name='role',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='permissions.Role'),
        ),
        migrations.AddField(
            model_name='user',
